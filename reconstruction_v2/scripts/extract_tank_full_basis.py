...
out=V2/'qa/tank_full_basis_r15.npz'
...
(V2/'qa/tank_full_basis_r15.json').write_text(json.dumps({'parameters':names,'cage_template':a,'linearity_error_m':err,'scope':'proposal outer skin only; final full stack required'},indent=2),encoding='utf8')
